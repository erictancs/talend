...
public class Demo implements TalendJob {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "NbYc6L_" + subJobPidCounter.getAndIncrement());
...
///////////////////////    			
				...
				props_tDataStewardshipTaskOutput_1.connection.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:nKzlSktOw4LyvS2zGI5jWsH7RGeS3r6589DY6VlokGotjzrfUF2W2g=="));
...
// ###############################
					...
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:MgHVf2pG5QcHSKCs6say27gUgOcWGyP7G2xiXbNFtCYDt5EdtA==")
									.substring(0, 4) + "...");
							log4jParamters_tDBInput_1.append(" | ");
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:zuNvKXnIibAJsnm4mz8LT50lPWzy42jxi9pf80GKIEjmONiZyQ==");
...
// finally of generic
	...
	public void tSendMail_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "OTnh3b_" + subJobPidCounter.getAndIncrement());
					...
					class BytesLimit65535_tSendMail_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tSendMail_1.append("AUTH_PASSWORD" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:5nC1OM12U3NdnV9K3vsl4J+fr+3k3PktliApayUmZAOeeGMGDw==")
									.substring(0, 4) + "...");
							log4jParamters_tSendMail_1.append(" | ");
							...
							new javax.mail.Authenticator() {
								protected javax.mail.PasswordAuthentication getPasswordAuthentication() {
									...
									final String decryptedPassword_tSendMail_1 = routines.system.PasswordEncryptUtil
											.decryptPassword(
													"enc:routine.encryption.key.v1:fUunRo0Qi6QDPdqM+Rxm8NdziIEcmNB6b71Ll4tcKwifhq1W0g==");
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "n9Ql2w_" + subJobPidCounter.getAndIncrement());
...
// Start of branch "row2"
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "LXJ3xk_" + subJobPidCounter.getAndIncrement());
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-02-02T03:25:25.628846100Z");
...
/************************************************************************************************
 * 323560 characters generated by Talend Cloud Data Fabric on the 2 February
 * 2024 at 11:25:25 AM SGT
 ************************************************************************************************/