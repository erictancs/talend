...
public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "JVVxcA_" + subJobPidCounter.getAndIncrement());
...
org.talend.components.datastewardship.tdatastewardshiptaskoutput.TDataStewardshipTaskOutputProperties props_tDataStewardshipTaskOutput_1 =
        (org.talend.components.datastewardship.tdatastewardshiptaskoutput.TDataStewardshipTaskOutputProperties) def_tDataStewardshipTaskOutput_1.createRuntimeProperties();
 		                    ...
 		                    "eric.tan@nfr.siftag.com");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:vi1knAY+UA/kvUjQQlqnzat4Dn/uSiDtw+fP1vvx1Yg7cvjksd2sUQ=="));
 ...
 */
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:eh4hauAqMHksrE1JVuGeZ0W5viljY0QNIK4MmLds6CrlpYobNw==").substring(0, 4) + "...");     
                        log4jParamters_tDBInput_1.append(" | ");
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:ohJeKHZBuIcNN7QV23JYDbvH60tCBJPgv9jRjm/wUj5YvJcH2A==");
...
public void tSendMail_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "KyHWMk_" + subJobPidCounter.getAndIncrement());
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tSendMail_1{
                    ...
                    log4jParamters_tSendMail_1.append("Parameters:");
                        ...
                        log4jParamters_tSendMail_1.append(" | ");
                            log4jParamters_tSendMail_1.append("AUTH_PASSWORD" + " = " + String.valueOf("enc:routine.encryption.key.v1:vkiY7rxkQKaL2D/U6YLtM6oEdIs8n1OdyTETtqS+KVrH5KQfUA==").substring(0, 4) + "...");     
                        log4jParamters_tSendMail_1.append(" | ");
...
+"e your attention.") ;
	...
	final String decryptedPassword_tSendMail_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:OB6Iv7mIRv41kqSqiY9C2V/lqEc+7wsli0L1JPiAkIN7s3nHlg==");
...
public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "wE6apR_" + subJobPidCounter.getAndIncrement());
                ...
                class BytesLimit65535_tFileInputDelimited_1{
                    ...
                    log4jParamters_tFileInputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                            log4jParamters_tFileInputDelimited_1.append("FILENAME" + " = " + "\"C:/SIFT/Developer/Talend/Data/Demo/Customers_Email.csv\"");
                        log4jParamters_tFileInputDelimited_1.append(" | ");
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("C:/SIFT/Developer/Talend/Data/Demo/Customers_Email.csv", "UTF-8",",","\n",false,1,0,
...
public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "cH2ibP_" + subJobPidCounter.getAndIncrement());
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'Demo' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2024-01-12T03:29:46.718259100Z");
...
/************************************************************************************************
 *     322275 characters generated by Talend Cloud Data Fabric 
 *     on the 12 January 2024 at 11:29:46 AM SGT
 ************************************************************************************************/