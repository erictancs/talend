...
public class DataPrep implements TalendJob {
	...
	public void tDatasetInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "Em02yP_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDataprepRun_1_DataprepOut {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDataprepRun_1_DataprepOut.append(" | ");
							log4jParamters_tDataprepRun_1_DataprepOut
									.append("PREPARATION_ID" + " = " + "\"fdad0893-4a22-4a35-8d66-c887b2988dae\"");
							log4jParamters_tDataprepRun_1_DataprepOut.append(" | ");
							if (log.isDebugEnabled())
								log.debug(
				...
				final String decryptedPassword_tDataprepRun_1_DataprepOut = routines.system.PasswordEncryptUtil
						.decryptPassword(
								"enc:routine.encryption.key.v1:X0csRJN7T8G0gAXzSskhnbfdCvPmtI3zBxYrHG9zRAHRfVfGaWv+NQ==");
...
// Getting authentication tokent
				...
				preparationId_tDataprepRun_1_DataprepOut = "fdad0893-4a22-4a35-8d66-c887b2988dae";
...
//Set the preparation version id to "head"  if no version was provided in the parameters
				...
				props_tDatasetInput_1.setValue("pass", routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:B0opP5nsiydR2kPLMZsyOzZ3K2NZ0y6TTYlfiZiSWyuEpq6VioJ8qQ=="));
...
// finally of generic
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "ccmt3A_" + subJobPidCounter.getAndIncrement());
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-02-01T06:23:59.605516900Z");
...
/************************************************************************************************
 * 193100 characters generated by Talend Cloud Data Fabric on the 1 February
 * 2024 at 2:23:59 PM SGT
 ************************************************************************************************/