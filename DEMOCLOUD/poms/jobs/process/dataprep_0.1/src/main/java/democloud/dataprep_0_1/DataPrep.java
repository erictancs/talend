...
public class DataPrep implements TalendJob {
	...
	public void tDatasetInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "AmaWWA_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDataprepRun_1_DataprepOut {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDataprepRun_1_DataprepOut.append(" | ");
							log4jParamters_tDataprepRun_1_DataprepOut
									.append("PREPARATION_ID" + " = " + "\"d6d7fb5d-94b8-4eb4-88c8-f36a1021a596\"");
							log4jParamters_tDataprepRun_1_DataprepOut.append(" | ");
							if (log.isDebugEnabled())
								log.debug(
				...
				final String decryptedPassword_tDataprepRun_1_DataprepOut = routines.system.PasswordEncryptUtil
						.decryptPassword(
								"enc:routine.encryption.key.v1:uyCom3vBoX8Hk0LN9VURxHSD+le4VIhai75WZZY8ahcMWdC/acKtRA==");
...
// Getting authentication tokent
				...
				preparationId_tDataprepRun_1_DataprepOut = "d6d7fb5d-94b8-4eb4-88c8-f36a1021a596";
...
//Set the preparation version id to "head"  if no version was provided in the parameters
				...
				props_tDatasetInput_1.setValue("pass", routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:htViICk+NlE57CQrGl2R1bqEphkHm5t5udKGasln6CKj5lR+jG2mjQ=="));
...
// finally of generic
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "WZYPaX_" + subJobPidCounter.getAndIncrement());
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-04-25T03:11:04.483356300Z");
...
/************************************************************************************************
 * 193189 characters generated by Talend Cloud Data Fabric on the 25 April 2024
 * at 11:11:04 AM SGT
 ************************************************************************************************/