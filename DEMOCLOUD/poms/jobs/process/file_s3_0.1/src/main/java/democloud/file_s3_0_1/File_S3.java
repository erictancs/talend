...
public class File_S3 implements TalendJob {
	static {System.setProperty("TalendJob.log", "File_S3.log");}
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_bi3FQIREEe6K79Ugdc6UFA", "0.1");
...
public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "UQcTq0_" + subJobPidCounter.getAndIncrement());
                ...
                class BytesLimit65535_tFileOutputDelimited_1{
                    ...
                    log4jParamters_tFileOutputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
                            log4jParamters_tFileOutputDelimited_1.append("FILENAME" + " = " + "context.param_file_path + \"/\" + jobName + \"/out.csv\"");
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.param_file_path + "/" + jobName + "/out.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:/cWJzKXqJqMDEF9fsFVdrPm25oDlEgPyYX1OddtK/UpSuExLmQ==").substring(0, 4) + "...");     
                        log4jParamters_tDBInput_1.append(" | ");
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:U/EIzfKTMaz/dD05nh3sWnLDX9Z8H2nO7K6cmPP3VzDnrgc0QA==");
...
if(CustomersOut != null) { 
	...
	currentComponent="tFileOutputDelimited_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"CustomersOut","tMap_1","tMap_1","tMap","tFileOutputDelimited_1","tFileOutputDelimited_1","tFileOutputDelimited"
    			...
    			if(log.isTraceEnabled()){
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            CustomersOut.First_Name
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(CustomersOut.Last_Name != null) {
                        sb_tFileOutputDelimited_1.append(
                            CustomersOut.Last_Name
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        sb_tFileOutputDelimited_1.append(
                            CustomersOut.Occupation
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(CustomersOut.MaritalStatus != null) {
                        sb_tFileOutputDelimited_1.append(
                            CustomersOut.MaritalStatus
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
		...
		resourceMap.put("finish_tFileOutputDelimited_1", true);
				...
				log.debug("tFileOutputDelimited_1 - Written records count: " + nb_line_tFileOutputDelimited_1 + " .");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"CustomersOut",2,0,
			 			"tMap_1","tMap_1","tMap","tFileOutputDelimited_1","tFileOutputDelimited_1","tFileOutputDelimited","output")) {
						talendJobLogProcess(globalMap);
					}
...
public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "a4iP4s_" + subJobPidCounter.getAndIncrement());
...
public void tPrejob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "vqNmI5_" + subJobPidCounter.getAndIncrement());
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "foTO9Q_" + subJobPidCounter.getAndIncrement());
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tS3Connection_1{
                    ...
                    log4jParamters_tS3Connection_1.append("Parameters:");
                        ...
                        log4jParamters_tS3Connection_1.append(" | ");
                            log4jParamters_tS3Connection_1.append("SECRET_KEY" + " = " + String.valueOf("enc:routine.encryption.key.v1:0IlUYLAE9s3mzyy3NBZZ+oHCpOPUvXfWYlPnWlAhEDSqfZr+ozetb1Ad/kdETfQGPH5MhEZUENmE4FEI4yRqCKAsGz4=").substring(0, 4) + "...");     
                        log4jParamters_tS3Connection_1.append(" | ");
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:i4cTqgAr7XXwUkACMybcauuse7S4mxuWEap7Ji5hoYCpGI0elj6c/LWBVBahH9zavcva3rXQw8prQ9NePt2voa4zUMc=");

            com.amazonaws.auth.AWSCredentials credentials_tS3Connection_1 = new com.amazonaws.auth.BasicAWSCredentials("AKIA425JNRQCIW5KV35H",decryptedPassword_tS3Connection_1);
...
public void tPostjob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "AanvKL_" + subJobPidCounter.getAndIncrement());
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "xnr8M0_" + subJobPidCounter.getAndIncrement());
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tS3Put_1{
                    ...
                    log4jParamters_tS3Put_1.append("Parameters:");
                        ...
                        log4jParamters_tS3Put_1.append(" | ");
                            log4jParamters_tS3Put_1.append("FILE" + " = " + "\"C:/SIFT/Developer/Talend/Data/test/out.csv\"");
                        log4jParamters_tS3Put_1.append(" | ");
    ...
    com.amazonaws.services.s3.model.ObjectMetadata objectMetadata_tS3Put_1 = new com.amazonaws.services.s3.model.ObjectMetadata();
		...
		if(!useStream_tS3Put_1) {
    		...
    		tm_tS3Put_1 = com.amazonaws.services.s3.transfer.TransferManagerBuilder
  			...
  			com.amazonaws.services.s3.model.PutObjectRequest putRequest_tS3Put_1 = new com.amazonaws.services.s3.model.PutObjectRequest("sift-et-bucket", key_tS3Put_1, inputFile_tS3Put_1).withMetadata(objectMetadata_tS3Put_1);
      	...
      	S3StreamUtil streamUtil_tS3Put_1 = new S3StreamUtil();
    		...
    		if(!multiUpload_tS3Put_1) {
    				...
    				com.amazonaws.services.s3.model.PutObjectRequest putRequest_tS3Put_1 = new com.amazonaws.services.s3.model.PutObjectRequest("sift-et-bucket", key_tS3Put_1, uploadStream_tS3Put_1, objectMetadata_tS3Put_1);
      			...
      			com.amazonaws.services.s3.model.InitiateMultipartUploadRequest putRequest_tS3Put_1 = new com.amazonaws.services.s3.model.InitiateMultipartUploadRequest("sift-et-bucket", key_tS3Put_1, objectMetadata_tS3Put_1);
				...
				try {
            		...
            		com.amazonaws.services.s3.model.CompleteMultipartUploadRequest compRequest_tS3Put_1 = new com.amazonaws.services.s3.model.CompleteMultipartUploadRequest("sift-et-bucket", key_tS3Put_1,
...
globalMap.put("tS3Put_1_ERROR_MESSAGE",uploadException_tS3Put_1.getMessage());
  							conn_tS3Put_1.abortMultipartUpload(new com.amazonaws.services.s3.model.AbortMultipartUploadRequest("sift-et-bucket", key_tS3Put_1, uploadId_tS3Put_1));
...
public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "F8odit_" + subJobPidCounter.getAndIncrement());
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'File_S3' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2024-01-12T04:14:29.862174300Z");
        ...
        try {
            ...
            java.io.InputStream inContext = File_S3.class.getClassLoader().getResourceAsStream("democloud/file_s3_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = File_S3.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("param_file_path")) {
...
/************************************************************************************************
 *     203104 characters generated by Talend Cloud Data Fabric 
 *     on the 12 January 2024 at 12:14:29 PM SGT
 ************************************************************************************************/