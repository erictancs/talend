...
public class DataSteward implements TalendJob {
	...
	public void tDataStewardshipTaskInput_1Process(final java.util.Map<String, Object> globalMap)
		...
		org.slf4j.MDC.put("_subJobPid", "KIAUQ1_" + subJobPidCounter.getAndIncrement());
...
///////////////////////    			
				...
				props_tDataStewardshipTaskInput_1.connection.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:Kv+a2WZKwKcLfraAwN24EAhxfOuJYmG8mV/Zpjq5nA+C6/saZtXnhQ=="));
...
// finally of generic
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "p3nNYU_" + subJobPidCounter.getAndIncrement());
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-04-25T02:46:27.896985900Z");
