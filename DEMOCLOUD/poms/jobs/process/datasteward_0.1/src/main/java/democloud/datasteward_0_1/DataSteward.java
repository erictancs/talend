...
public class DataSteward implements TalendJob {
	...
	public void tDataStewardshipTaskInput_1Process(final java.util.Map<String, Object> globalMap)
		...
		org.slf4j.MDC.put("_subJobPid", "BZrZ5Y_" + subJobPidCounter.getAndIncrement());
...
///////////////////////    			
				...
				props_tDataStewardshipTaskInput_1.connection.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:jJChrIoIT6BsLNIYY1URXmh7umgw94aBwFZtt0Rby80JsTw5RZHB3Q=="));
...
///////////////////////		
						...
						if (row2.First_Name != null) { //
							...
							strBuffer_tLogRow_1.append(String.valueOf(row2.First_Name));
						...
						if (row2.Age != null) { //
							...
							strBuffer_tLogRow_1.append(String.valueOf(row2.Age));
						...
						if (row2.Occupation != null) { //
							...
							strBuffer_tLogRow_1.append(String.valueOf(row2.Occupation));
						...
						if (row2.MaritalStatus != null) { //
							...
							strBuffer_tLogRow_1.append(String.valueOf(row2.MaritalStatus));
						...
						if (row2.Salary != null) { //
							...
							strBuffer_tLogRow_1.append(String.valueOf(row2.Salary));
						...
						if (row2.Address != null) { //
							...
							strBuffer_tLogRow_1.append(String.valueOf(row2.Address));
...
// finally of generic
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "hHNd7f_" + subJobPidCounter.getAndIncrement());
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-11-14T07:46:02.843904600Z");
...
/************************************************************************************************
 * 161798 characters generated by Talend Cloud Data Fabric on the 14 November
 * 2023 at 3:46:02 PM SGT
 ************************************************************************************************/